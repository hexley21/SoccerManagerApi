...
// Source: github.com/hexley21/soccer-manager/pkg/hasher (interfaces: Hasher)
//
// Generated by this command:
//
//	mockgen -destination=mock/mock_hasher.go -package=mock github.com/hexley21/soccer-manager/pkg/hasher Hasher
//
